...
const CompaniesBar = props => {
  const [barPosition, setBarPosition] = React.useState<Number>(100); // Green bar position by the default it's -20px
  const [barAbovePosition, setBarAbovePosition] = React.useState<Number>(100);
